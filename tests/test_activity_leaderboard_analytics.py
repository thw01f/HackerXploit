...
def app():
    ...
    with app.app_context():
        ...
        student = User(username='student', email='student@test.org', role='member', status='approved', is_first_login=False, student_id='ST-101', full_name='Alice Student', onboarding_completed=True)
