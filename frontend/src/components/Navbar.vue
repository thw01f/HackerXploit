  ...
  <header class="sticky top-0 z-50 bg-[#0b0e14]/90 border-b border-[#1f293d] backdrop-blur-md">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
      ...
      <nav v-if="authStore.isAuthenticated" class="hidden xl:flex items-center space-x-1">
        ...
        <router-link to="/leaderboard" class="nav-link text-amber-400 flex items-center gap-1" active-class="nav-link-active">
        ...
        <router-link to="/id-card" class="nav-link text-[#00f0ff] flex items-center gap-1" active-class="nav-link-active">
        ...
        <template v-if="authStore.isAuthenticated">
          ...
          <div class="relative">
            <button @click="toggleNotifications" class="relative p-2 rounded-lg text-slate-400 hover:text-[#9fef00] hover:bg-[#151f30] transition-colors">
              ...
              <span v-if="unreadCount > 0" class="absolute top-1 right-1 w-2.5 h-2.5 bg-red-500 rounded-full animate-ping"></span>
